...
| -------- | --------------- | ------------ |
| 感知与上下文 | 屏幕、语音、通知、日程、时间与位置、使用习惯、长期记忆与跨设备状态 | 图片输入、屏幕观察、无障碍节点、时间与位置、设备状态、近期通知与会话历史 |
...
Eta 作为第三方项目，正在验证这条路线中可以在现有 Android、Root、无障碍和用户授权边界内实现的部分：以同一套 Agent Runtime 编排系统工具、GUI、浏览器、Shell、Linux 与 Skills，让 Android 系统能力直达和第三方 App 的通用界面操作互为补充。更完整的 Agentic OS 仍需要长期记忆、跨设备状态、端侧模型、硬件资源调度、数据治理和第三方生态共同演进。
